...
if("TRUE" STREQUAL "TRUE")
  set(sailing_robot_SOURCE_PREFIX /root/USV_V1/To_computer_simulation/src/sailing_robot)
  set(sailing_robot_DEVEL_PREFIX /root/USV_V1/To_computer_simulation/devel)
  ...
  set(sailing_robot_INSTALL_PREFIX /root/USV_V1/To_computer_simulation/install)
...
if(NOT "/root/USV_V1/To_computer_simulation/devel/include " STREQUAL " ")
  set(sailing_robot_INCLUDE_DIRS "")
  set(_include_dirs "/root/USV_V1/To_computer_simulation/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sailing_robot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/USV_V1/To_computer_simulation/src/sailing_robot/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/USV_V1/To_computer_simulation/devel/lib;/root/alinx/test_ws/devel/lib;/opt/ros/kinetic/lib)
